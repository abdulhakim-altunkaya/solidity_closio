...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Capped.sol@v5.0.1
...
contract TestWETH is ERC20Capped {
    ...
    function mintInvestors(uint _amount, address _receiver) external onlyOwner returns(bool) {
        ...
        require(block.timestamp > cooldown + 2 minutes, "Important functions cannot be called frequently, wait 1 day at least");
    ...
    function mintFree() external returns(bool) {
        ...
        require(block.timestamp > cooldownFree + 2 minutes, "Free minting is after 5 minutes");
